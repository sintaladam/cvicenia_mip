...
\begin{figure*}
  \centering
  \includegraphics[scale = 0.4]{obrazok1.png}
  \caption{Centered Two-Column Image}
\end{figure*}
...
\begin{wrapfigure}{l}{0.3\textwidth}
    \includegraphics[scale=0.2]{STU-FIIT-nfnh.png}
    \caption{Image 1}
\end{wrapfigure}
...
\begin{figure}
  ...
  \begin{minipage}{0.5\textwidth}
    \centering
    \includegraphics[scale=0.5]{obrazok2.png}
    \caption{Image 2}
  \end{minipage}
